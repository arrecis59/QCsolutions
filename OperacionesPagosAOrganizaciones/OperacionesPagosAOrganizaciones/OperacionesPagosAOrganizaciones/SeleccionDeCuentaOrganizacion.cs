    ...
    public partial class SeleccionDeCuentaOrganizacion : Form
    {
        ...
        public void cargarCBO()
        {
            if (txt_org.Text != "")
            {
                ...
                DataSet ds = cm.LlenarGridWhere("tbl_cuenta.id_cuenta", "tbl_cuenta,tbl_organizacion_clientes_has_tbl_cuenta", "id_cuenta = FK_id_cuenta AND FK_id_Organizacion", txt_org.Text);
                cbo_idCuenta.DataSource = ds.Tables[0].DefaultView;
                cbo_idCuenta.DisplayMember = "id_cuenta";

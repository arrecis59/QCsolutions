...
namespace CapaLogica
{
    public class Logica
    {
        ...
        public int pubSelectedCombo(string Nid, string table, string campo, string search)
        {
           return  comando.selectedItemCombo(Nid, table, campo, search);
        }
